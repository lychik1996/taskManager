...
const resetInviteCodeSpace = async ({param}:ResetInviteCodeRequest):Promise<ResetInviteCodeResponse>=>{

    const res = await axios.post(`/api/protect/workspaces/reset-invite-code/${param}`);
